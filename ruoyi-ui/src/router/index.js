...
export const constantRoutes = [
  ...
  },
  {
    ...
    component: Layout,
    hidden: true,
    meta: { title: "疫苗管理", icon: "appointment" },
    children: [
      // 疫苗浏览页面
      {
        path: "user",
        name: "vaccineAppointment",
        component: () => import("@/views/vaccine/appointment/user"),
        meta: { title: "疫苗预约", icon: "eye" },
      },
      // 我的预约页面
      {
        path: "my",
        name: "myappointment", // ⭐️ 这是你在代码中应该使用的name
        component: () => import("@/views/vaccine/appointment/my"),
      ...
      // 预约表单页面（通常隐藏，通过链接访问）
      {
        ...
        component: () => import("@/views/vaccine/appointment/form"),
        meta: {
          title: "预约接种",
          icon: "form",
          activeMenu: "/vaccine/appointment/user",
        },
      },
      {
        path: "index",
